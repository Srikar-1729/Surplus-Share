...
export default function Donate() {
    ...
    return (
        <div className="w-full h-full flex justify-center pt-14">
            ...
            <form
                className="h-fit p-6 bg-white w-1/2 shadow-lg flex flex-col gap-6"
            ...
            >
                ...
                <div className="flex justify-between">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <Label htmlFor="option-two">{"Non-Veg"}</Label>
                            </div>
                        </RadioGroup>
                    </div>
                    ...
                    <div>
                        ...
                        <RadioGroup
                            defaultValue="none"
                            onValueChange={(value) => setValue("can_deliver", value)}
                        >
                            <div className="flex items-center space-x-2">
                ...
                <div>
                    ...
                    <Textarea {...register("food_description")} />
                </div>
                ...
                <div>
                    ...
                    <Input id="address" type="text" {...register("location")} />
                </div>
                ...
                <div className="flex justify-center">
                    ...
                    <button
                        onClick={handleClick}
                        className={`border-2 border-black text-white rounded bg-green-500 text-2xl px-7 py-2 ${
